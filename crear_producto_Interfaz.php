    ...
    <body>
        ...
        <div class="container2">
            <div class="form-box">
                ...
                <form class="input-group" name="crearProducto" method="post" action="crear_producto.php">
                    <input type="file" class="input-field" name="imagen" accept=".jpg, .jpeg, .png" required>
                    <input type="text" class="input-field" name="nombreProducto" placeholder="Nombre del Producto" required>
                    <input type="text" class="input-field" name="precio" placeholder="Precio" pattern="[0-9]{1,3}" required>
                    <input type="number" class="input-field" name="stock" min="1" max="150" value="75" placeholder="Stock disponible" required>
                    ...
                    <button type="submit" class="submit-btn" name="btn-cp" style="margin-left: 10%;">Crear</button>
                </form>
            </div> 
        </div>
    </body>
