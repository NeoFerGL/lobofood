                ...
                <nav class="navbar navbar-expand-sm">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav ms-lg-auto">
                            <li class="nav-item">
                                <a class="nav-link text-light lead-x" href="carrito.php" style="font-weight:bold; cursor:pointer;" data-bs-toggle="modal" data-bs-target="#modal_cart">
                                    Mi carrito <i class="fas fa-shopping-cart">
                                ...
                                <div class="card-body" style="text-align: center">
                                    ...
                                    <div class="d-flex justify-content-between align-self-center">
                                        <div class="btn-group" style="width: 100%;">
                                            ...
                                            <?php } else { ?>
                                                <button class="btn btn-secondary addToCart" type="submit" style="font-weight:bold; font-size: large;" disabled>Agregar a Cuenta <i class="fas fa-shopping-cart"></i></button>
                                            <?php } ?>
